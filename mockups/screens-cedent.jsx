// Cedent-side views (toggled from nav)
  ...
  return (
    <div className="page">
      <header className="page-head">
        <div>
          <div className="eyebrow">Cedent Portal · Government of Jamaica · Ministry of Finance</div>
        ...
        <div className="card">
          ...
          <div style={{ padding: 22 }}>
            <div className="kv mb-24">
              <div className="k">Counter-party</div><div className="v">2,140 investors</div>
            ...
            {[
              { date: "2026-09-30", amount: 3_375_000, label: "Q3 premium" },
              { date: "2026-12-31", amount: 3_375_000, label: "Q4 premium" },
              { date: "2027-03-31", amount: 3_375_000, label: "Q1 premium" },
            ].map((p, i) => (
      ...
      <section className="grid g-3 mb-24">
        ...
        <div className="vault-card" onClick={() => setNewCoverage(true)} style={{ borderStyle: "dashed", justifyContent: "center", alignItems: "center", padding: 40, cursor: "pointer", textAlign: "center" }}>
          ...
          <div className="mono" style={{ fontSize: 11, color: "var(--ink-3)", marginTop: 6, maxWidth: 200 }}>
            Define trigger, term, and capacity. Co-design with the RIZK team.
          </div>
        </div>
      </section>
...
const CEDENT_SHORT = "Jamaica MoF";
const CEDENT_LONG = "Government of Jamaica · Ministry of Finance";
let __reqSeq = 13;
...
const NewCoverageModal = ({ onClose, onCreate, onUpdate, goTo, editVault }) => {
  ...
  const [f, setF] = useState(editVault && editVault.request ? { ...editVault.request } : {
    name: "Jamaica Hurricane Cover 2026",
    peril: "Tropical cyclone + flood",
    region: "Jamaica — national parametric box",
    limit: 10,
    term: "24 months",
